...
class AppTest {
    ...
    int indexOfChar = 1;
    char correctChar = 'e';
    String substringMiddle = "edc";

    @Test
    void testToStringReversedSequence() {
        assertThat(sequence.toString()).isEqualTo(reversed);
    }

    @Test
    void testLengthReversedSequence() {
        assertThat(sequence.length()).isEqualTo(length);
    }

    @Test
    void testCharAtReversedSequence() {
        assertThat(sequence.charAt(indexOfChar)).isEqualTo(correctChar);
    }

    @Test
    void testSubsequenceReversedSequence() {
        assertThat(sequence.subSequence(1, 4).toString()).isEqualTo(substringMiddle);
    }
    // END
}
